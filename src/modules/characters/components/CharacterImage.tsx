...
export const CharacterImage:FC<Props> = ({ url }):JSX.Element => {
    ...
    return (
        <>
            <div 
                className={`rounded-md h-[190px] cursor-zoom-in overflow-hidden ${ !isLoaded && "hidden" }`}
                onClick={ handleZoom }
            >
                <img 
            ...
            { 
                ...
                (
                    <div 
                        className='flex items-center justify-center animate-pulse rounded-md h-[190px] bg-gray-300 dark:bg-gray-700 fade-out'
                    >
